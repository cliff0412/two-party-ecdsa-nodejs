...
export class KeyGeneration {
    ...
    public async generatePaillierKeyPair(): Promise<PaillierKeyPair> {
        let keyPairGenerator: PaillierKeyPairGenerator = new PaillierKeyPairGenerator(2048);
        return keyPairGenerator.generateKeyPair();
    }

    public computeEcdsaPublicKey(ecdsaPrivateKeyShare: BN, point: ECPoint): ECPoint {
